...
//$('ul#nav > .dropdown').click(function () {
//    $("dropdown-menu").addClass("display: none;");
//});

$('ul#nav .dropdown').click(function () { $('ul#nav .dropdown').focus(); });
//$('ul#nav .dropdown').hover(function () { return true; });

//$('ul#nav .dropdown .dropdown-menu .dropdown-link').click(function () { return true; });
