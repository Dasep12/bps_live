...
namespace Core.VSSP.Views.Reports {
    ...
    public class RPT_TRS_503 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Core.VSSP.Views.Reports.RPT_TRS_503.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_TRS_503 : Component, ICachedReport {
        
        public CachedRPT_TRS_503() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_TRS_503 rpt = new RPT_TRS_503();
            rpt.Site = this.Site;
            return rpt;
        }
