...
namespace Core.VSSP.Views.Reports {
    ...
    public class RPT_TRS_210 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Core.VSSP.Views.Reports.RPT_TRS_210.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_TRS_210 : Component, ICachedReport {
        
        public CachedRPT_TRS_210() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_TRS_210 rpt = new RPT_TRS_210();
            rpt.Site = this.Site;
            return rpt;
        }
