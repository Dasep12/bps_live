...
namespace Core.VSSP.Views.Reports {
    ...
    public class RPT_TRS_109 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Core.VSSP.Views.Reports.RPT_TRS_109.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_TRS_109 : Component, ICachedReport {
        
        public CachedRPT_TRS_109() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_TRS_109 rpt = new RPT_TRS_109();
            rpt.Site = this.Site;
            return rpt;
        }
