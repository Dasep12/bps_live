...
namespace Core.VSSP.Views.Reports {
    ...
    public class RPT_TRS_008 : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Core.VSSP.Views.Reports.RPT_TRS_008.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRPT_TRS_008 : Component, ICachedReport {
        
        public CachedRPT_TRS_008() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RPT_TRS_008 rpt = new RPT_TRS_008();
            rpt.Site = this.Site;
            return rpt;
        }
